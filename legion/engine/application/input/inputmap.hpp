...
namespace legion::application
{
    struct inputmap
    {
        enum class modifier_keys : uint8
        {
            NONE = 0,
            CTRL = 1,
            ALT = 2,
        ...
        static uint8 value(modifier_keys m)
        {
            return static_cast<uint8>(m);
        }

        friend uint8 operator-(modifier_keys lhs, modifier_keys rhs)
        {
        ...
        friend modifier_keys operator+(modifier_keys lhs, uint8 rhs)
        {
