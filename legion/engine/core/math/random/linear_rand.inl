...
namespace legion::core::math
{
    ...
    L_NODISCARD Scalar linear_rand(Scalar min, Scalar max) noexcept
    {
    ...
    namespace detail
    {
        ...
        struct compute_linear_rand<vector<Scalar, Size>>
        {
            ...
            L_NODISCARD static auto compute(const vec_type& min, const vec_type& max) noexcept
            {
                vec_type result;
            ...
            L_NODISCARD static auto compute(Scalar min, Scalar max) noexcept
            {
                vec_type result;
                for (size_type i = 0; i < Size; i++)
