...
namespace legion::core::math
{
    ...
    inline L_ALWAYS_INLINE constexpr vector<Scalar, 3>::vector(const vector<scalar, 2>& v, scalar s) noexcept : vector(v.x, v.y, s) {}

    template<typename Scalar>
    inline L_ALWAYS_INLINE constexpr vector<Scalar, 3>::vector(scalar s, const vector<scalar, 2>& v) noexcept : vector(s, v.x, v.y) {}

    template<typename Scalar>
    inline L_ALWAYS_INLINE constexpr vector<Scalar, 3>::vector(scalar _x, scalar _y, scalar _z) noexcept : x(_x), y(_y), z(_z) {}
