...
namespace legion::rendering
{
    ...
    struct model_handle
    {
        ...
        void write_buffer(const buffer& buffer, uint index, size_type size, GLenum type,bool normalized, size_type stride,size_type offset, bool perInstance) const;
    ...
    public:
        ...
        static void write_buffer(id_type id,const buffer& buffer, uint index, size_type size, GLenum type, bool normalized, size_type stride, size_type offset, bool perInstance);
